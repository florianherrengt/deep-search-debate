...
function centeredPage(
  ...
  return (
    ...
    >
      {seo === "sign-in" ? <SignInSeo /> : null}
      {seo === "waitlist" ? <WaitlistSeo /> : null}
      {content}
    </Box>
  )
}
...
/** Marks the unlisted sign-in flow non-indexable. */
function SignInSeo() {
...
export function AuthGate({
  ...
  const authConfigQuery = useQuery({
    ...
    enabled: showSignIn && sessionQuery.data === null,
    staleTime: Infinity,
  })
